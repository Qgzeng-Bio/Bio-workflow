...
for path in config/Input_Manifest.tsv config/result_manifest.yaml reports/Analysis_Plan.md reports/workflow_status.tsv reports/Task_Status.tsv reports/Acceptance_Report.md reports/Methods_Summary.md reports/Delivery_Index.md; do
